...
//triggers when clicked on plus icon inside card and pops a modal and that modal provides the input
...
//function below it just check container is empty or not and creates the card according to user
...
//function below it attached to mark as done btn and takes value as the paramter
//then as the same value is attached to text as id it finds that element  and change font
...
//function below creates the card on main container traverses through the set of objects and creates the card
